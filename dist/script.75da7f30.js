  ...
  request.onloadend = function () {
    if (request.status == 404) {
      ...
      var _JSON$parse = JSON.parse(this.responseText),
          ...
          data = _JSON$parse2[0]; // convert string to array containing object and destructure the array


      p.remove(); // render country
